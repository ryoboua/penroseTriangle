...
let material = new THREE.MeshLambertMaterial({ color: "#F64061", flatShading: true })
...
let tl = new TimelineMax({ repeat: -1, repeatDelay: 0.01 });
tl.to(group.rotation, 2, { y: THREE.Math.degToRad(15), ease: Expo.easeOut });
